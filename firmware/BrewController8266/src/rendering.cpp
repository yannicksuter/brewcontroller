...
Button controls[CONTROL_COUNT] = {
  Button(CNTL_TIME_PLUS, 1, 37, PLUS_UP_WIDTH, PLUS_UP_HEIGHT, PLUS_UP_DATA, PLUS_DOWN_DATA),
  Button(CNTL_TIME_MINUS, 1, 81, MINUS_UP_WIDTH, MINUS_UP_HEIGHT, MINUS_UP_DATA, MINUS_DOWN_DATA),
  Button(CNTL_TIMER, 278, 37, PLAY_UP_WIDTH, PLAY_UP_HEIGHT, PLAY_UP_DATA, PLAY_DOWN_DATA, PAUSE_UP_DATA, PAUSE_DOWN_DATA),
  Button(CNTL_TEMP_PLUS, 1, 148, PLUS_UP_WIDTH, PLUS_UP_HEIGHT, PLUS_UP_DATA, PLUS_DOWN_DATA),
  Button(CNTL_TEMP_MINUS, 1, 192, MINUS_UP_WIDTH, MINUS_UP_HEIGHT, MINUS_UP_DATA, MINUS_DOWN_DATA),
  Button(CNTL_HEATER, 278, 148, PLAY_UP_WIDTH, PLAY_UP_HEIGHT, PLAY_UP_DATA, PLAY_DOWN_DATA, PAUSE_UP_DATA, PAUSE_DOWN_DATA)
};
